    ...
    const plans = [
        {
          ...
          features: [
            ...
            "Basic crop, resize and bg remover",
            "Color adjustments",
        ...
        },
        {
          ...
          featured: true,
          planId: "cplan_31zqHZiO86eQh8W6ExUAOnlN4ne",
        ...
        <div className="max-w-6xl mx-auto px-6 ">
            <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                    Start free and upgrade when you need more function tools. No hidden fees, cancel anytime.
                </p>
            </div>
