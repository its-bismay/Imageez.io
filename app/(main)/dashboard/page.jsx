    ...
    <div className="min-h-screen pt-32 pb-16">
      <div className="container mx-auto px-6">
        ...
        Projects
          ...
          <h3 className="text-2xl font-semibold text-white mb-3">Create a Project</h3>
          <p className="text-white/70 mb-8 max-w-md">Upload an image and start editing with amazing tools.</p>
          ...
          <NewProjectModel isOpen={showNewProjectModal} onClose={() => setShowNewProjectModal(false)}/>
      </div>
    </div>
  )
}
